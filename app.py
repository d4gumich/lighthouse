...
# Configuration
# =========================
BASE_MODEL = "meta-llama/Meta-Llama-3.1-8B-Instruct"  # <-- PRESENT IN HUGGINGFACE USE THAT
LORA_REPO  = "your-username/job-reco-lora"   # <-- CHANGE THIS TO THE ACTUAL LORA UPLOAD ONCE UPLOADED
